...
export const isAllCoursesLoadingSelector = (state: CoursesState) =>
  state.isAllCoursesLoading;
export const isSearchingStateSelector = (state: CoursesState) =>
  state.isSearchState;
export const isSingleCourseLoadingSelector = (state: CoursesState) =>
